namespace JbQuasirandom
{
    ...
    public class SobolSequence
    {
        ...
        private readonly long[,] v = new long[MaxDimensions, ColumnCount];
        ...
        public SobolSequence(int dimensionCount) : this(dimensionCount, 0)
        {
        }
        ...
        private void InitializeRemainingRowsOfV()
        {
            for (int i = 1; i < dimensionCount; i++)
            {
                //  The bit pattern of the integer POLY(I) gives the form of polynomial I.
            ...
            reciprocalDenominator = 1.0 / (2.0 * factor);
        }

        private void InitializeStaticPartOfV()
        {
            // data by Joe and Kuo, see https://web.maths.unsw.edu.au/~fkuo/sobol/, http://doi.acm.org/10.1145/641876.641879
